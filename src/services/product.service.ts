...
export class ProductService {
  ...
  async create({name, description, image, value, personCount, disponibility, categoryId}: CreateProductDto): Promise<CreatedProductDto> {
    try {
      const createProduct = this.productRepository.create({category:{id:categoryId}, name, description, image, value, personCount, disponibility});
